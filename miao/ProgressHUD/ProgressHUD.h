...
#define HUD_STATUS_COLOR		[UIColor colorWithRed:0.5 green:0.5 blue:0.5 alpha:1]

//#define HUD_SPINNER_COLOR		[UIColor colorWithRed:185.0/255.0 green:220.0/255.0 blue:47.0/255.0 alpha:1.0]
#define HUD_SPINNER_COLOR       [UIColor colorWithRed:0.92 green:0.39 blue:0.39 alpha:1]
