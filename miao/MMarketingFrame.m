...
@implementation MMarketingFrame
-(void)setMarketing:(MMarketing *)marketing{
    ...
    CGSize titleLabelSize=[marketing.m_title boundingRectWithSize:CGSizeMake(titleW, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:titleAttrDict context:nil].size;
...
//    CGFloat dateH=12;
    ...
    CGSize dateLabelSize=[marketing.m_date boundingRectWithSize:CGSizeMake(MAXFLOAT, MAXFLOAT) options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:dateAttrDict context:nil].size;
//        _dateF=(CGRect){{dateX,dateY},dateLabelSize};
    ...
    CGSize sourceLabelSize=[marketing.m_source boundingRectWithSize:CGSizeMake(sourceW, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:sourceAttrDict context:nil].size;
...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    [aCoder encodeObject:_marketing forKey:@"marketing"];
...
-(id)initWithCoder:(NSCoder *)aDecoder{
    if (self=[super init]) {
        _marketing=[aDecoder decodeObjectForKey:@"marketing"];
